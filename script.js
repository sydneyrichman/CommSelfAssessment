...
function updateCounter() {
  ...
  checkboxes.forEach((checkbox, index) => {
    if (checkbox.checked) {
      ...
      else if(index % 80 === 3 || index % 80 === 6 || index % 80 === 11 || index % 80 === 15 || index % 80 === 19 || index % 80 === 22 || index % 80 === 27 || index % 80 === 29 || index % 80 === 35 || index % 80 === 38 || index % 80 === 43 || index % 80 === 46 || index % 80 === 49 || index % 80 === 56 || index % 80 === 59 || index % 80 === 64 || index % 80 === 67 || index % 80 === 71 || index % 80 === 76 || index % 80 === 0){
        styleThree++;
      }
      else {
        styleFour++;
